...
parser.add_argument('--distractor3_path', type=str, help='Load path of distractor3')
...
def main(args):
    ...
    with open(args.distractor1_path, 'r') as f:
        all_distractors_1 = [a.rstrip() for a in f.readlines()]

    with open(args.distractor2_path, 'r') as f:
        all_distractors_2 = [a.rstrip() for a in f.readlines()]

    with open(args.distractor3_path, 'r') as f:
        all_distractors_3 = [a.rstrip() for a in f.readlines()]

    all_gen_questions = [question + " [SEP] " + distractor1 + " [SEP] " + distractor2 + " [SEP] " + distractor3 for question, distractor1, distractor2, distractor3 in zip(all_questions, all_distractors_1, all_distractors_2, all_distractors_3)]
